                ...
                <div class="d-none d-lg-flex justify-content-end">
                    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                        <ul class="navbar-nav ms-auto">
                           <?php if(basename($_SERVER['PHP_SELF']) === "login.php" || basename($_SERVER['PHP_SELF']) === "register.php" ): ?>
                                <li class="nav-item">
                                    <a class="nav-link text-white py-2" href="../">Home</a>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link text-white py-2" href="../portfolio">Portfolio</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link text-white py-2" href="../privacy_policy">Privacy Policy</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <?php else: ?>
                                 <li class="nav-item">
                                    <a class="nav-link text-white py-2" href="index">Home</a>
                                <li class="nav-item">
                                    <a class="nav-link text-white py-2" href="services">Services</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a href="auth/login" class="btn btn-outline-light ms-2">Login</a>
                                </li>
                            <?php endif; ?>
                        </ul>
                    </div>
